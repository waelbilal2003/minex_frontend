...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          _userData?['display_name'] ?? widget.userName ?? 'ملف شخصي',
        ),
      ...
      child: Column(
        children: [
          ...
          ElevatedButton.icon(
            ...
            label: Text('مراسلة'),
            onPressed: () {
              // التحقق من عدم مراسلة النفس (اختياري)
              ...
              // الانتقال الفوري دون إرسال رسالة
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ChatPage(
                    conversationId: -1, // مؤشر أن المحادثة غير معروفة بعد
